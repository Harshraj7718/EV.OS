...
export const PrivacyPolicy = () => {
  return (
    <>
      <SEO
        title="Privacy Policy | Booklynk EV"
      ...
      <LegalPageLayout eyebrow="Legal" title="Privacy Policy" lastUpdated="21 July 2026">
        ...
        <LegalSection title="2. Information We Collect">
          ...
          <ul className="ml-5 list-disc space-y-2">
            ...
            <li>
              ...
              collected when you initiate a payment. We do <strong>not</strong> collect or store
              your card, UPI, or bank account details — these are entered directly into Razorpay's
              secure checkout and never pass through our servers.
            </li>
            <li>
              <span className="font-medium text-foreground">Usage preferences</span> — your
              light/dark theme preference, stored locally in your browser (see Section 7, Cookies
              and Local Storage).
            </li>
          </ul>
        </LegalSection>
        ...
        <LegalSection title="4. Third-Party Service Providers">
          <p>
            We share limited information with the following service providers, solely to operate the
            Service:
          </p>
          <ul className="ml-5 list-disc space-y-2">
            <li>
        ...
        <LegalSection title="8. Your Rights">
          ...
          <ul className="ml-5 list-disc space-y-2">
            ...
            <li>
              Request deletion of your information, subject to legal or regulatory retention
              requirements; and
            </li>
